...
class FillPermissionsForGymStaffType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGymStaffType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gym-staff-type',
            'admin.gym-staff-type.index',
            'admin.gym-staff-type.create',
            'admin.gym-staff-type.show',
            'admin.gym-staff-type.edit',
            'admin.gym-staff-type.delete',
            'admin.gym-staff-type.bulk-delete',
        ]);
