...
class FillPermissionsForGymLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGymLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gym-location',
            'admin.gym-location.index',
            'admin.gym-location.create',
            'admin.gym-location.show',
            'admin.gym-location.edit',
            'admin.gym-location.delete',
            'admin.gym-location.bulk-delete',
        ]);
