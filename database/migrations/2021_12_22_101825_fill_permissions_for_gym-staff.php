...
class FillPermissionsForGymStaff extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGymStaff constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gym-staff',
            'admin.gym-staff.index',
            'admin.gym-staff.create',
            'admin.gym-staff.show',
            'admin.gym-staff.edit',
            'admin.gym-staff.delete',
            'admin.gym-staff.bulk-delete',
        ]);
